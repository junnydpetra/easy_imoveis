...
class ImovelRequest extends FormRequest
{
    ...
    public function messages()
    {
        return[
            ...
            'titulo.min' => ':min é a quantidade mínima de caracteres para o campo',
            'rua.min' => ':min é a quantidade mínima de caracteres para o campo',
            'bairro.min' => ':min é a quantidade mínima de caracteres para o campo'
        ];
    }
}
